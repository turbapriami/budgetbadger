      ...
      <Box align="left" pad="large">
              <Paragraph margin="none" >
                ...
                <h3><b onClick={props.handleSubmit} >Name: </b>
                  <li style={{ listStyleType: "none" }}>
                    <b>First Name: </b><TextInput onDOMChange={(e) => props.handleForm(e)} name="first_name" defaultValue={props.userInfo.first_name}/>
                  </li>
                  <li style={{ listStyleType: "none" }}>
                    <b>Last Name: </b><TextInput onDOMChange={(e) => props.handleForm(e)} name="last_name" defaultValue={props.userInfo.last_name}/>
                  </li>
                </h3>}
              </Paragraph>
            ...
            <Paragraph margin="none">
              ...
              <h3><b onClick={props.handleSubmit} >Address: </b>
                <li style={{ listStyleType: "none" }}>
                  <b>Street </b><TextInput onDOMChange={(e) => props.handleForm(e)} name="street" defaultValue={props.userInfo.street}/>
                </li>
                <li style={{ listStyleType: "none" }}>
                  <b>State </b><TextInput onDOMChange={(e) => props.handleForm(e)} name="state" defaultValue={props.userInfo.state}/>
                </li>
                <li style={{ listStyleType: "none" }}>
                  <b>ZIP Code </b><TextInput onDOMChange={(e) => props.handleForm(e)} name="zip_code" defaultValue={props.userInfo.zip_code}/>
                </li>
              </h3> }
            </Paragraph>
            <div style={{ outline: "#a8a8a8 solid thin", marginBottom: "25px" }} ></div>       
            <Paragraph margin="none" >
              ...
              <h3><b onClick={props.handleSubmit} >Email: </b>
                <li style={{ listStyleType: "none" }}>
                  <TextInput onDOMChange={(e) => props.handleForm(e)} name="email" defaultValue={props.userInfo.email}/>
                </li>
              </h3>
              }
            </Paragraph>
            ...
            <Paragraph margin="none" >
              ...
              <li style={{ listStyleType: "none" }} >
                <TextInput size={{ height: "small", width: "large"}} onDOMChange={(e) => props.handleForm(e)} name="phone" defaultValue={props.userInfo.phone}/>
              </li>
              </h3> }
            </Paragraph>
      </Box>
